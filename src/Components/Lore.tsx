                ...
                <Grid container item direction="row" >
                    <Grid item xs={12} md={6}>
                            ...
                            <Card style={{
                                ...
                                height: '100%',
                                background: 'linear-gradient(to right bottom, #1c386655,#001d3b33)',
                                borderRadius: '0px',
                                alignItems: ' center',
                                justifyContent: ' center'
                            }}>
                        ...
                        >
                            ...
                            <Slide in={true} direction='up' timeout={2000}>
                                <div className='PageContainer'>
                                    <Typography paddingBottom={'25px'} paddingTop={'25px'} fontFamily='Dongle' letterSpacing={'10px'} align={width < 960 ? "center" : "left"} lineHeight={0} color={'#00a6ff66'} fontWeight='bold' variant='subtitle1' fontSize='1.25rem'>
                                            //DISCOVERING
                                    </Typography>
                                    <div className="glow">
                                        <Typography fontFamily='Dongle' align={width < 960 ? "center" : "left"} color={'#00a6ffFF'} variant='h3' lineHeight={'2.5rem'} fontSize='5.5rem' fontWeight='900'>THE BOBOTS.</Typography>
                                    </div>
