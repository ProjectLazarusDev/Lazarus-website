    ...
    <>
      <Grid container spacing={3} direction="column" alignItems="center" justifyContent="center">
        <Grid container item direction="row" style={{ boxShadow: 'none' }}>
                  ...
                  <div className="PageContainer">
                    ...
                    <div className="glowWhite">
                      ...
                      >
                        ...
                        Robots have dominantly replace humans with cute robots being stationed on the moon. These bobots
                        lives on the ethereum network using the <b>ERC-721 blockchain.</b>
                      </Typography>
                      <Grid
                        xs
                        width={'100%'}
          ...
          <Grid xs={12} md={6} height={'100vh'} style={{ boxShadow: '0px' }}></Grid>
        </Grid>
      </Grid>
    </>
  );
