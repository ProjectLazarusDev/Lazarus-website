        ...
        <ThemeProvider theme={themeDark}>
          <Grid container spacing={3} direction="column" alignItems="center" justifyContent="center">
            <Grid container item direction="row" style={{ boxShadow: 'none' }}>
                      ...
                      <div className="PageContainer">
                        ...
                        <div className="glowWhite">
                          <Typography
                            ...
                            fontSize="1.6rem"
                          >
                            <b>Bobots is a 3D blockchain game</b> using Arbitrum as the host for our own Bobots
                            meta-verse. The <b>long term vision of Bobots</b> is to create an environment where
                            community can hang out in real-time and also stake their assets.
                          </Typography>
                          <Grid
                            container
                            spacing={0}
              ...
              {width > 960 && <Grid xs={12} md={6} height={'100vh'} style={{ boxShadow: '0px' }}></Grid>}
            </Grid>
          </Grid>
