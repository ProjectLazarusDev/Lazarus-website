...
const EDMUND: TeamProps = {
    name: 'EDMUND',
    role: '3D ARTIST',
    description1: 'Experienced 3D Artist with varying expertise from game \
    art, video editing and commercials to VFX!',
...
const THEON: TeamProps = {
    ...
    description1: 'Artist turned software engineer. \
...
const FARZAANA: TeamProps = {
    name: 'FARZAANA',
    role: 'WEB3 DEVELOPER',
    description1: 'Artist turned software engineer, from 3D game art to creating \
    custom game engines.',
...
const ELSTON: TeamProps = {
    name: 'ELSTON',
    role: 'MARKETING',
    description1: 'Online marketing professional with many years of sales \
    background moving into the NFT space.',
...
const YIEN: TeamProps = {
    ...
    description2: 'Coding up the multiplayer component and gameplay aspects of \
    the project. He regards himself as a NPC in real life.'
};
...
const SHERMAN: TeamProps = {
    name: 'SHERMAN',
    role: 'GAME PROGRAMMER',
    description1: 'Unity developer and game designer that has worked on both \
    commercial game engines and custom engines.',
...
const QIWEN: TeamProps = {
    name: 'QI WEN',
    role: 'WEB DEVELOPER',
    description1: 'Assisting in web development and \
    linking up smart contracts with Unity code for \
